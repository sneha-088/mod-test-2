...
//     document.getElementById('displayInfo').classList.remove('hide');
...
//     document.getElementById('displayInfo').classList.add('hide');
//     attempt--;
//     console.log(`attempt remaining= ${attempt}`);
//     document.getElementById('attemptsLeft').innerText = attempt;
//     document.getElementById('diceWthScore').classList.remove('hide');
...
//                 document.getElementById('diceWthScore').classList.add('hide');
//                 document.getElementById('tryAgainImage').classList.remove('hide');
//             }
//         }
//     }
// }
...
//     }
//     document.getElementById('congratsImage').classList.remove('hide');
